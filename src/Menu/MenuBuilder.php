...
class MenuBuilder
{
    ...
    public function createMenuTree(): ItemInterfaceMenu{
        ...
        $menu = $cache->get("menu_cache", function (ItemInterface $categoryMenu){
            ...
            $categories = $cache->get('categories_Cache', function (ItemInterface $item) use ($cacheTime): ?array {
            ...
            $menu['index']['headerMenu']->addChild('Orders',  ['uri' => $this->router->generate('app_account_orders')]);
            $menu['index']['headerMenu']['Orders']->addChild('Order details',  ['uri' => $this->router->generate('app_account_order_details')]);

            $menu['index']['headerMenu']->addChild('About us',  ['uri' => $this->router->generate('app_about_index')]);
